...
import br.edu.ufrj.lwcoedge.resourceprovisioner.service.ResourceProvisionerService;

@RestController
@RequestMapping("/resourceprovisioner")
public class ResourceProvisionerController {

	@Autowired
	private ResourceProvisionerService service;
